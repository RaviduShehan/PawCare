...
$(document).on("click", "#star-icon", function() {
  window.location.href = "/pages/Favourites/game2.html";
});

$(document).on("click", "#camera-icon", function() {
  window.location.href = "/pages/Camera/game2.html";
});

$(document).on("click", "#train-icon", function() {
  window.location.href = "/pages/BookTicket/game2.html";
});

$(document).on("click", "#settings-icon", function() {
  window.location.href = "/pages/Settings/game2.html";
});

$(document).on("click", "#avatar-img", function() {
  window.location.href = "/pages/Profile/game2.html";
});
